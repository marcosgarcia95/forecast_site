...
class Program(models.Model):
    ...
    internal_ord_list = models.CharField(max_length=1000, default="")
...
class QuarterPeriod(models.Model):
    ...
    forecast_period = models.ForeignKey('ForecastPeriod', on_delete=models.CASCADE)
    enter_inputs = models.BooleanField(default = True)
...
class Forecast(models.Model):
    ...
    # quarter_period = models.ManyToManyField('QuarterPeriod')
